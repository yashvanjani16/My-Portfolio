  ...
  (max-width:1200px) 50vw,50vw'
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              ...
              <div className='flex items-center self-start mt-2 lg:self-center'>
                <Link title="Download Resume" href="/yash-cv.pdf" target={"_blank"} className='flex items-center bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-light hover:text-dark border-2 border-solid border-transparent hover:border-dark md:p-2 md:px-4 md:text-base'
                  download={true}
